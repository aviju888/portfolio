...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <Section>
      {/* Back link */}
      <Link href="/code" className="inline-flex items-center text-gray-500 hover:text-gray-900 mb-8 transition-colors text-sm">
        ← All Projects
      </Link>
      ...
      {project.images[0] && (
        <div className="mb-10">
          <div className="relative aspect-video rounded-xl overflow-hidden border border-gray-200 bg-gray-100 max-w-4xl">
            <Image
